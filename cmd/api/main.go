...
import (
	...
	"erp/pkg/httpserver"
	"erp/pkg/postgres"
	httpadapter "erp/services/assets-service/internal/adapters/http"
	pgadapter "erp/services/assets-service/internal/adapters/postgres"
	stockclient "erp/services/assets-service/internal/adapters/stock"
	"erp/services/assets-service/internal/application"
	"erp/services/assets-service/migrations"
)
...
func main() {
	...
	svc := application.New(pgadapter.New(pool), stockclient.New(cfg.StockBaseURL), postgres.NewSequence(pool, "asset_tag"))
